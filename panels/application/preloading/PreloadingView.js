...
const UIStrings = {
     ...
     */
    warningDetailPrefetchDisabledByHoldback: 'Prefetch is forced-enabled because DevTools is open. When DevTools is closed, prefetch will be disabled because this browser session is part of a holdback group used for performance comparisons.',
    /**
     *@description Title in infobar
     */
     ...
     *@description Detail in infobar
     */
    warningDetailPrerenderingDisabledByHoldback: 'Prerendering is forced-enabled because DevTools is open. When DevTools is closed, prerendering will be disabled because this browser session is part of a holdback group used for performance comparisons.',
    /**
...
class PreloadingUIUtils {
    ...
    static preloadsStatusSummary(ruleSet, countsByRuleSetId) {
        const LIST = [
...
export class PreloadingWarningsView extends UI.Widget.VBox {
    ...
    onWarningsUpdated(args) {
        ...
        // disabled.
        function createDisabledMessages(event) {
        ...
        if (detailsMessage !== null) {
            ...
            if (event.disabledByHoldbackPrefetchSpeculationRules) {
                this.showInfobar(i18nString(UIStrings.warningTitlePrefetchDisabledByHoldback), i18nString(UIStrings.warningDetailPrefetchDisabledByHoldback));
            }
            if (event.disabledByHoldbackPrerenderSpeculationRules) {
                this.showInfobar(i18nString(UIStrings.warningTitlePrerenderingDisabledByHoldback), i18nString(UIStrings.warningDetailPrerenderingDisabledByHoldback));
            }
        }
    }
