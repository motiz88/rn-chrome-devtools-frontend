...
export declare class TimelinePanel extends UI.Panel.Panel implements Client, TimelineModeViewDelegate {
    ...
    loadingComplete(tracingModel: TraceEngine.Legacy.TracingModel | null, exclusiveFilter?: TimelineModel.TimelineModelFilter.TimelineModelFilter | null): Promise<void>;
